...
j<-0.000
for (i in 1:10000){
  esiti[i]<-esito_test((c+j),datimiei$`numero guasti`,0.10)
  cc[i]<-c+j
  j<-j+0.001
}
#cbind(cc,esiti)
...
{chisquares[i]<-trovamiglior_c(valc1[i],datimiei$`numero guasti`,0.10)}
...
j<-0.000
for (i in 1:10000){
  esiti[i]<-esito_test((c+j),datimiei$`numero guasti`,0.05)
  cc[i]<-c+j
  j<-j+0.001
}
#cbind(cc,esiti)
...
{chisquares[i]<-trovamiglior_c(valc2[i],datimiei$`numero guasti`,0.05)}
round(chisquares,digits=4)
...
j<-0.000
for (i in 1:10000){
  esiti[i]<-esito_test((c+j),datimiei$`numero guasti`,0.01)
  cc[i]<-c+j
  j<-j+0.001
}
#cbind(cc,esiti)
...
{chisquares[i]<-trovamiglior_c(valc3[i],datimiei$`numero guasti`,0.01)}
round(chisquares,digits=4)
