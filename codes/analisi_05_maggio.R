...
datimiei<-as.data.frame(read_excel("../datasets/months/05_maggio.xlsx"))
...
#frequenze assolute
table(cut(datimiei$Prezzo,breaks=cc(-1,2,5,10,20,30,40,50,100,200,300,400,500,2000,4000,10600)))
